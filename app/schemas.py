...
# ---------------------------------------------------------------------------
# Industry indicators response models
# ---------------------------------------------------------------------------

class IndustryIndicatorItem(BaseModel):
    """One stock's latest indicators returned by the industry endpoint."""
    ticker_id: int
    name: str
    trade_date: date
    computed_date: date
...
class IndustryIndicatorsResponse(BaseModel):
    """Response for GET /screener/industry/{basic_ind_code}/indicators"""
    basic_ind_code: str
    page: int
    page_size: int
    total: int
    stocks: list[IndustryIndicatorItem]
